 ...
 * percent: 百分比
 */
export declare type ProColumnsValueType =
  | 'money'
  | 'textarea'
  | 'option'
  | 'date'
 ...
 */
export declare type ProColumnsValueTypeFunction<T> = (
  item: T,
 ...
 * @param valueType
 */
declare const defaultRenderText: <T, U>(
  ...
  valueType:
    ...
    | 'digit'
    | 'avatar'
    | ProColumnsValueTypeFunction<T>,
  index: number,
  item?: T | undefined,
  columnEmptyText?: string | false | undefined,
) => React.ReactNode;
