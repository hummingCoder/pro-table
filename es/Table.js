...
var genEllipsis = function genEllipsis(dom, item, text) {
  ...
  return React.createElement(
    ...
    React.createElement('span', null, dom),
  );
};
...
var genColumnList = function genColumnList(columns, map, counter, columnEmptyText) {
  return columns
    .map(function (item, columnsIndex) {
      ...
      var valueEnum = ObjToMap(item.valueEnum);
      ...
      var tempColumns = _objectSpread(
        ...
        {},
        {
          ...
          filters:
            filters === true
              ? parsingValueEnumToArray(valueEnum).filter(function (valueItem) {
...
var ProTable = function ProTable(props) {
  ...
  var tableDom = React.createElement(
    _Table,
    Object.assign({}, rest, {
  ...
  var tableAreaDom = React.createElement(React.Fragment, null, toolbarDom, alertDom, tableDom);
