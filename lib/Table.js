    ...
    _objectSpread(
      {
        showTotal: function showTotal(all, range) {
          return ''
            .concat(intl.getMessage('pagination.total.range', '第'), ' ')
            .concat(range[0], '-')
            .concat(range[1], ' ')
            .concat(intl.getMessage('pagination.total.total', '条/总共'), ' ')
            .concat(all, ' ')
            .concat(intl.getMessage('pagination.total.item', '条'));
        },
...
var genEllipsis = function genEllipsis(dom, item, text) {
  ...
  return _react.default.createElement(
    ...
    _react.default.createElement('span', null, dom),
  );
};
...
var columnRender = function columnRender(_ref) {
  ...
  var renderTextStr = renderText(
    (0, _util.parsingText)(text, (0, _util.ObjToMap)(valueEnum)),
    row,
    index,
    action.current,
  );
  ...
  var dom = genEllipsis(
    ...
    item,
    renderText(
      (0, _util.parsingText)(text, (0, _util.ObjToMap)(valueEnum), true),
      row,
      index,
      action.current,
    ),
...
var genColumnList = function genColumnList(columns, map, counter, columnEmptyText) {
  return columns
    .map(function (item, columnsIndex) {
      ...
      var valueEnum = (0, _util.ObjToMap)(item.valueEnum);
      ...
      var tempColumns = _objectSpread(
        ...
        {},
        {
          ...
          filters:
            filters === true
              ? (0, _util.parsingValueEnumToArray)(valueEnum).filter(function (valueItem) {
...
var ProTable = function ProTable(props) {
  ...
  var _useState = (0, _react.useState)(function () {
      ...
      return (_rest$form = rest.form) === null || _rest$form === void 0
        ? void 0
        : _rest$form.initialValues;
    }),
  ...
  var fetchPagination =
    _typeof(propsPagination) === 'object'
      ? propsPagination
      : {
          defaultCurrent: 1,
          defaultPageSize: 20,
  ...
  var action = (0, _useFetchData.default)(
    ...
    defaultData,
    {
      ...
      effects: [
        (0, _useJsonComparison.stringify)(params),
        (0, _useJsonComparison.stringify)(formSearch),
        (0, _useJsonComparison.stringify)(proFilter),
        (0, _useJsonComparison.stringify)(proSort),
      ],
    },
  );
  (0, _react.useEffect)(
      ...
      var userAction = {
        ...
        reload: (function () {
          var _reload = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(resetPageIndex) {
              var current;
        ...
        reloadAndRest: (function () {
          var _reloadAndRest = _asyncToGenerator(
  ...
  (0, _util.useDeepCompareEffect)(
    function () {
      var tableColumn = genColumnList(propsColumns, counter.columnsMap, counter, columnEmptyText);

      if (tableColumn && tableColumn.length > 0) {
        counter.setColumns(tableColumn); // 重新生成key的字符串用于排序

        counter.setSortKeyColumns(
          tableColumn.map(function (item, index) {
    ...
    function () {
      ...
      if (keys.length > 0) {
        ...
        tableColumn = tableColumn.sort(function (a, b) {
          ...
          var aKey = ''
            .concat((0, _util.genColumnKey)(a.key, a.dataIndex, aIndex), '_')
            .concat(aIndex);
          var bKey = ''
            .concat((0, _util.genColumnKey)(b.key, b.dataIndex, bIndex), '_')
            .concat(bIndex);
  ...
  (0, _react.useEffect)(
    function () {
      ...
      if (Array.isArray(dataSource)) {
        ...
        var rows = []
          .concat(_toConsumableArray(dataSource), _toConsumableArray(selectedRows))
  ...
  var toolbarDom =
    toolBarRender !== false &&
    (options !== false || headerTitle || toolBarRender) && // if options= false & headerTitle=== false, hide Toolbar
    _react.default.createElement(_toolBar.default, {
      ...
      onSearch: function onSearch(keyword) {
        if (options && options.search) {
          ...
          setFormSearch(
            _objectSpread(_objectSpread({}, formSearch), {}, _defineProperty({}, name, keyword)),
          );
        }
      },
  ...
  var tableDom = _react.default.createElement(
    _table.default,
    Object.assign({}, rest, {
        ...
        if (Array.isArray(sorter)) {
          var data = sorter.reduce(function (pre, value) {
            ...
            return _objectSpread(
              _objectSpread({}, pre),
              {},
              _defineProperty({}, ''.concat(value.field), value.order),
            );
          }, {});
          setProSort(data);
  ...
  var tableAreaDom = _react.default.createElement(
