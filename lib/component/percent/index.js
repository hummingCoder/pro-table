...
var Percent = function Percent(_ref) {
  ...
  var realValue = (0, _react.useMemo)(
    function () {
      return typeof value === 'string' && value.includes('%')
        ? (0, _lodash.default)(value.replace('%', ''))
        : (0, _lodash.default)(value);
    },
    [value],
  );
  ...
  return _react.default.createElement(
    ...
    prefix && _react.default.createElement('span', null, prefix),
    showSymbol &&
      _react.default.createElement(
        _react.Fragment,
        null,
        (0, _util.getSymbolByRealValue)(realValue),
        '\xA0',
      ),
    (0, _util.getRealTextWithPrecision)(realValue, precision),
    suffix && suffix,
  );
};
