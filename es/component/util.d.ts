 ...
 */
export declare const parsingText: (
  text: string | number,
  valueEnum?: ValueEnumMap | undefined,
 ...
 * @param valueEnum
 */
export declare const parsingValueEnumToArray: (
  valueEnum?: ValueEnumMap | undefined,
) => {
  value: string | number;
  text: string;
...
export declare function useDebounceFn<T extends any[]>(
  fn: (...args: T) => any,
 ...
 * @param obj
 */
export declare const removeObjectNull: (obj: { [key: string]: any }) => {};
export declare const ObjToMap: (
  value: ValueEnumObj | ValueEnumMap | undefined,
) => ValueEnumMap | undefined;
/**
 * 减少 width，支持 string 和 number
 */
export declare const reduceWidth: (
