  ...
  if (!valueType || valueType === 'text') {
    ...
    if (valueEnum) {
      return React.createElement(
        ...
        parsingValueEnumToArray(ObjToMap(valueEnum)).map(function (_ref) {
  ...
  Object.keys(value).forEach(function (key) {
    ...
    if (Array.isArray(itemValue) && itemValue.length === 2 && dateFormatter) {
      if (dateFormatter === 'string') {
        ...
        tmpValue[key] = [
          moment(startValue).format(_formatString || 'YYYY-MM-DD HH:mm:ss'),
          moment(endValue).format(_formatString || 'YYYY-MM-DD HH:mm:ss'),
        ];
        return;
      }
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(React.Fragment, null, domList),
              ),
              React.createElement(
                _Col,
                Object.assign({}, colConfig, {
