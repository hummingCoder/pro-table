  ...
  if (valueType === 'dateRange' && text && Array.isArray(text) && text.length === 2) {
    ...
    return _react.default.createElement(
      ...
      _react.default.createElement(
        'div',
        null,
        startText ? (0, _moment.default)(startText).format('YYYY-MM-DD') : '-',
      ),
      _react.default.createElement(
        'div',
        null,
        endText ? (0, _moment.default)(endText).format('YYYY-MM-DD') : '-',
      ),
    );
  }
  /**
  ...
  if (valueType === 'dateTimeRange' && text && Array.isArray(text) && text.length === 2) {
    ...
    return _react.default.createElement(
      ...
      _react.default.createElement(
        'div',
        null,
        _startText ? (0, _moment.default)(_startText).format('YYYY-MM-DD HH:mm:ss') : '-',
      ),
      _react.default.createElement(
        'div',
        null,
        _endText ? (0, _moment.default)(_endText).format('YYYY-MM-DD HH:mm:ss') : '-',
      ),
    );
  }
  /**
