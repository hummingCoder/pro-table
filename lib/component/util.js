...
var parsingText = function parsingText(text, valueEnum, pure) {
  ...
  if (domText.status) {
    ...
    var Status = _status.default[status.toLowerCase() || 'Init'];

    if (Status) return _react.default.createElement(Status, null, domText.text);
...
var getLang = function getLang() {
  ...
  var browserLang = isNavigatorLanguageValid
