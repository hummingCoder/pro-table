...
var FormInputRender = _react.default.forwardRef(function (props, ref) {
  ...
  if (!valueType || valueType === 'text') {
    ...
    if (valueEnum) {
      return _react.default.createElement(
        ...
        (0, _util.parsingValueEnumToArray)((0, _util.ObjToMap)(valueEnum)).map(function (_ref) {
  ...
  if (valueType === 'dateRange') {
    return _react.default.createElement(
      _datePicker.default.RangePicker,
      Object.assign(
        {
          ref: ref,
          placeholder: [
      ...
      Object.assign(
        {
          ...
          formatter: function formatter(value) {
            if (value) {
              return ''
                .concat(intl.getMessage('moneySymbol', '￥'), ' ')
                .concat(value)
                .replace(/\B(?=(\d{3})+(?!\d))/g, ',');
            }
          ...
          parser: function parser(value) {
            return value
              ? value.replace(
                  new RegExp('\\'.concat(intl.getMessage('moneySymbol', '￥'), '\\s?|(,*)'), 'g'),
                  '',
                )
              : '';
          },
  ...
  Object.keys(value).forEach(function (key) {
    ...
    if (Array.isArray(itemValue) && itemValue.length === 2 && dateFormatter) {
      if (dateFormatter === 'string') {
        ...
        tmpValue[key] = [
          (0, _moment.default)(startValue).format(_formatString || 'YYYY-MM-DD HH:mm:ss'),
          (0, _moment.default)(endValue).format(_formatString || 'YYYY-MM-DD HH:mm:ss'),
        ];
        return;
      }
      ...
      if (dateFormatter === 'number') {
        ...
        tmpValue[key] = [
          (0, _moment.default)(_startValue).valueOf(),
          (0, _moment.default)(_endValue).valueOf(),
        ];
      }
    } // 都没命中，原样返回
...
var FormSearch = function FormSearch(_ref3) {
  ...
  var columnsList = counter.proColumns
  ...
  var domList = formInstanceRef.current
    ? columnsList
        .map(function (item) {
          ...
          _react.default.createElement(
              ...
              initialValues: columnsList.reduce(function (pre, item) {
                ...
                if (item.initialValue) {
                  return _objectSpread(
                    _objectSpread({}, pre),
                    {},
                    _defineProperty({}, key, item.initialValue),
                  );
                }
            ...
            _react.default.createElement(
              ...
              _react.default.createElement(
                ...
                _react.default.createElement(_react.default.Fragment, null, domList),
              ),
              _react.default.createElement(
                _col.default,
                Object.assign({}, colConfig, {
                  ...
                  className: (0, _classnames.default)(
                    ''.concat(className, '-option'),
                    _defineProperty({}, ''.concat(className, '-form-option'), isForm),
                  ),
                }),
                _react.default.createElement(
                  _form.default.Item,
